...
path('demov4s/delete/<task_id>', views.delete_task , name='delete_task'),
path('demov3s/delete/<task_id>', views.delete_task9 , name='delete_task9'),
path('demov2s/delete/<task_id>', views.delete_task8 , name='delete_task8'),
path('demov1s/delete/<task_id>', views.delete_task7 , name='delete_task7'),
path('demovs/delete/<task_id>', views.delete_task6 , name='delete_task6'),
